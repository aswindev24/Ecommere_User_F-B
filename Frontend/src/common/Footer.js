            ...
            <div className="payment-methods">
              ...
              <div className="payment-icon mastercard">
                <svg width="40" height="25" viewBox="0 0 40 25">
                  ...
                  <circle cx="25" cy="12.5" r="6" fill="#EB001B" fillOpacity="0.8" />
                </svg>
              </div>
              <div className="payment-icon amex">
                <svg width="40" height="25" viewBox="0 0 40 25">
                  <rect width="40" height="25" fill="#2E77BC" rx="3" />
                  <text x="20" y="15" textAnchor="middle" fill="white" fontSize="10" fontWeight="bold">AMEX</text>
                </svg>
              </div>
              <div className="payment-icon paypal">
                <svg width="40" height="25" viewBox="0 0 40 25">
                  <rect width="40" height="25" fill="#003087" rx="3" />
                  <text x="20" y="15" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold">PayPal</text>
                </svg>
              </div>
              <div className="payment-icon apple-pay">
                <svg width="40" height="25" viewBox="0 0 40 25">
                  <rect width="40" height="25" fill="black" rx="3" />
                  <text x="20" y="15" textAnchor="middle" fill="white" fontSize="8" fontWeight="bold"> Pay</text>
                </svg>
              </div>
            </div>
          </div>
