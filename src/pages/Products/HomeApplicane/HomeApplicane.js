...
const HomeAppliances = () => {
  ...
  const products = [
    ...
    },
    {
      ...
      name: 'Robot Vacuum',
      price: 399.99,
      image: 'https://unsplash.com/photos/a-yellow-and-black-vacuum-sitting-on-top-of-a-rug-pYt2vuXNoIU',
      category: 'Cleaning',
      brand: 'iRobot',
      rating: 4.3,
  ...
  return (
    <div className="homeAppliances">
      ...
      <div className="homeAppliancesMain">
        {/* Left Sidebar - Filters */}
        <div className="homeAppliances__left">
          <div className="homeAppliancesNavigation">
            <h3>FILTERS</h3>
        ...
        <div className="homeAppliances__right">
          <div className="homeAppliancesHeader">
            <div className="homeAppliancesBreadcrumbLink">
      ...
      <div className={`filterDrawer ${isDrawerOpen ? 'open' : ''}`}>
        ...
        <div className="drawerContent">
          <div className="homeAppliancesNavigation mobile">
            {/* Price Range Filter */}
            <div className="filterGroup">
              <h4>PRICE RANGE</h4>
              <div className="filterOptions">
